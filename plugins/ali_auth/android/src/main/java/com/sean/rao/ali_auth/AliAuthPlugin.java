  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    switch (call.method){
      ...
      case "getCurrentCarrierName":
        ...
        break;
      case "initSdk":
        PhoneNumberAuthHelper.getInstance(mActivity, null).setAuthPageUseDayLight(false);
      ...
      case "checkEnvAvailable":
        if(oneKeyLoginPublic != null){
          result.success(oneKeyLoginPublic.checkEnvAvailable());
        }else {
          PhoneNumberAuthHelper phoneNumberAuthHelper = PhoneNumberAuthHelper.getInstance(mActivity, null);
          phoneNumberAuthHelper.setAuthPageUseDayLight(false);
          phoneNumberAuthHelper.setAuthSDKInfo(call.argument("sk"));
          boolean value = phoneNumberAuthHelper.checkEnvAvailable();
