...
class MarqueeView extends StatefulWidget {
  ...
  /// ## Sample code
  ///
  /// This [MarqueeView] starts scrolling one second after being displayed.
  ///
  /// ```dart
  /// Marquee(
  ...
  /// The fraction of the [MarqueeView] that will be faded on the left or top.
  ...
  /// The fraction of the [MarqueeView] that will be faded on the right or down.
  /// By default, there won't be any fading.
  ///
  /// ## Sample code
  ///
  ...
  /// This function will be called if [numberOfRounds] is set and the [MarqueeView]
  ...
  @override
  State<StatefulWidget> createState() => _MarqueeViewState();
}
...
class _MarqueeViewState extends State<MarqueeView> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(Widget oldWidget) {
    super.didUpdateWidget(oldWidget as MarqueeView);
  }
  ...
  double _getTextWidth(BuildContext context) {
    ...
    if(text != null){
      return MarqueeView.getTextWidth(context: context, text: text);
    }
    return widget.childWidth ?? 0;
  }
  ...
  Widget build(BuildContext context) {
    ...
    Widget marquee = ListView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        final text = i.isEven
            ? widget.child ?? Text(widget.text ?? '', style: widget.style, textScaleFactor: widget.textScaleFactor)
            : _buildBlankSpace();
