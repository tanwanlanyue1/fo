...
///裸眼3d效果 from https://github.com/fluttercandies/flutter_interactional_widget/tree/main
class InteractionalView extends StatefulWidget {
  /// 控件宽度
  final double width;
  ...
  @override
  _InteractionalViewState createState() => _InteractionalViewState();
}

class _InteractionalViewState extends State<InteractionalView> {
  ...
  Widget build(BuildContext context) {
    final foregroundWidget = widget.foregroundWidget;
    final middleWidget = widget.middleWidget;
    final backgroundWidget = widget.backgroundWidget;
